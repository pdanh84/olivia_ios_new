...
;loader:any;ischecksearchbar=false;
  ...
  loadBlogSlug(regioncode, pagesize){
    ...
    let headers = { };
    this.gf.RequestApi('GET', urlStr, headers, { }, 'searchBlogmodal', 'loadBlogSlug').then((data)=>{
  ...
  likeItemblog(id) {
    ...
    se.storage.get('auth_token').then(auth_token => {
      if (auth_token) {
        ...
        this.gf.RequestApi('POST', urlStr, headers, { postId: id }, 'searchBlogmodal', 'likeItemblog').then((data)=>{
  ...
  unlikeItemblog(id) {
    ...
    se.storage.get('auth_token').then(auth_token => {
      if (auth_token) {
        ...
        let headers = { authorization: text };
        this.gf.RequestApi('POST', urlStr, headers, { postId: id }, 'searchBlogmodal', 'unlikeItemblog').then((data)=>{
      ...
      return new Promise ((resolve, reject)=>{ 
        se.storage.get('auth_token').then(auth_token => {
          if (auth_token) {
            ...
            this.gf.RequestApi('GET', urlStr, headers, { }, 'searchBlogmodal', 'getbloglike').then((data)=>{
